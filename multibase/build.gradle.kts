...
val currentModuleName: String = "multibase"
...
android {
    compileSdk = 34
    namespace = "tech.compubotics.multiformat.multibase"
    defaultConfig {
        minSdk = 21
    }
    compileOptions {
...
tasks.withType<DokkaTask>().configureEach {
    ...
    description = "MultiBase protocol implementation in Kotlin Multiplatform (KMP)"
    ...
    publications {
        withType<MavenPublication> {
            ...
            pom {
                ...
                description.set("multibase protocol implementation in Kotlin Multiplatform (KMP)")
